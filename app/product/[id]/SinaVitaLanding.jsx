    ...
    React.useEffect(() => {
        const handleScroll = () => {
            ...
            if (ctaBottomIfFixed > stoppDocumentTop) {
                ...
                const stopPosition = stoppDocumentTop - ctaHeight;
        ...
        <div className="min-h-screen bg-white font-sans relative">
            ...
            >
                <div className="flex flex-col items-center">
                    ...
                    <button className="bg-transparent border-4 border-white text-white px-8 py-4 rounded-lg text-xl font-bold hover:bg-white hover:text-orange-500 transition-all transform hover:scale-105 shadow-lg w-full md:w-auto">
                        GET YOUR KIT TODAY!
                    </button>
                </div>
            </div>
            ...
            <section className="bg-gradient-to-r from-yellow-500 to-orange-500 to-orange-400 px-4 lg:px-8 py-12 md:py-20">
                <div className="max-w-7xl mx-auto grid md:grid-cols-1 gap-8 items-center">
                    <div className="text-white space-y-6">
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                            MIGRAINES PAIN ENDS HERE
                        </h2>
            ...
            <section className="bg-gradient-to-r from-yellow-500 to-orange-500 to-orange-400 px-4 lg:px-8 py-12 md:py-20">
                <div className="max-w-7xl mx-auto grid md:grid-cols-1">
                    <h2 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold mb-8">
                        WHY IT<br />WORKS
                    </h2>

                    <p className="text-white text-sm mb-4 italic">(Instead of section: «Ingredients your head will love!!»)</p>
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-1 gap-8 items-center">
                    <div className="text-white space-y-6">
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight max-w-4xl">
                            YOUR COMPLETE MIGRAINE SUPPORT KIT
                        </h2>
            ...
            <section ref={qualitySectionRef} id="quality-section" className="bg-gradient-to-r from-yellow-500 to-orange-500 to-orange-400 px-4 lg:px-8 py-12 md:py-20">
                <div className="max-w-7xl mx-auto grid md:grid-cols-1 gap-8 items-center">
                    <div className="text-white space-y-6">
                        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight max-w-4xl">
                            QUALITY, SAFETY & TRUST BUILT INTO EVERY KIT
                        </h2>
